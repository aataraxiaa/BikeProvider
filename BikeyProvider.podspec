#
#  Be sure to run `pod spec lint BikeyProvider.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Pete Smith"
  # s.authors            = { "Pete Smith" => "peadar81@gmail.com" }
  s.social_media_url   = "http://twitter.com/superpeteblaze"
